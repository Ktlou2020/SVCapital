...
/* pwaInstall, _dismissPwaPrompt and _dismissIosBanner were removed with the
   banners they drove. Nothing called them — no markup, no handler, anywhere
   in this repository — and pwaInstall read _pwaPromptEvt, which went with the
   listener that set it. Left in place they would have thrown on the first
   caller. The working equivalents are svcInitAppBanner and
   svcDismissAppBanner at the foot of this file. */
...
/* The "get the app" banner moved to js/app-banner.js. It has to run on pages
   that do not load portal-core at all — login.html and signup.html are where
